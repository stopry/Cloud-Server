...
$(function () {
    ...
    $(".getVerCode").click(function () {
        ...
        if (canGet) {
            canGet = false;
            ajax.post(api.getCashCode, null, function (data) {
    ...
    $(".txjeIpt").blur(function () {
        ...
        ajax.get(api.getFree + "?money=" + money, null, function (datas) {
            if (datas.httpCode == 200) {
                $('#free').html(util.formatMoney(datas.data));
            } else {
                $('#free').html('2.00');
            }
        });
    ...
    $(".submitBtn").click(function () {
        ...
        if (!subDatas.money) {
            ...
            return;
        } else if (parseInt((subDatas.money))  > parseInt($("#ktxje").html())) {
